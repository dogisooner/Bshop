...
<html>
  ...
  <base href="<%=basePath%>">
	...
	<meta http-equiv="Refresh" content="2;url=book/book_showBookInfo?book.id=${book.id}">
...
<div id="wrap">
     ...
     <div class="center_content">
       	<div class="left_content">
        	<div class="crumb_nav">
            <a href="index.html">返回</a> &gt;&gt; 种类
            </div>
            <div class="title"><span class="title_icon"><img src="images/bullet1.gif" alt="" title="" /></span>书的种类</div>
