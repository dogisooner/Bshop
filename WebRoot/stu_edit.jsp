...
<div id="wrap">
     ...
     <div class="left_content">
            ...
            <p class="details">
                ...
                <div class="form_subtitle">修改用户信息</div>
                   <s:form action="user/user_updateUser" method="post">
			           <s:hidden name="user.id"></s:hidden>
			           <s:hidden name="user.username"></s:hidden>
			           <s:textfield name="user.stunum" label="学号"></s:textfield>
			           <s:textfield name="user.password" label="密码"></s:textfield>
			           <s:textfield name="user.nickname" label="昵称"></s:textfield>
			           <s:textfield name="user.phonenum" lable="电话"></s:textfield>
			           <s:textfield name="user.school" label="学校"></s:textfield>
			           <s:textfield name="user.academy" label="学院"></s:textfield>
			           <s:textfield name="user.major" label="专业"></s:textfield>
			           <s:textfield name="user.wealth" label="积分"></s:textfield> 
			           <s:textfield name="user.email" lable="邮箱"></s:textfield>
			           <s:textfield name="user.address" label="住址"></s:textfield>
