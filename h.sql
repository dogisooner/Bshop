...
insert  into `book`(`id`,`owner`,`bookname`,`press`,`credit`,`ISBN`,`type`,`uptime`,`prtime`,`page`,`size`,`status`,`delivery`,`img`,`writer`,`translator`) values (2,'hmj','王者归来','',0,'','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(3,'杜雨霏','看见','77',20,'','',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(4,'猴子','生猴子','花果山',0,'020','动物',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(5,'hmj','java程序设计','00000',3,'123','教材',NULL,NULL,'332','2',NULL,'物流',NULL,'xiaoliu','xiaoliu'),(6,'hmj','数据结构','清华大学出版社',2,'1322','技术类',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(7,'hmj','mysql自学视频教程','清华大学出版社',1,'4324','技术类',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(8,'hmj','软件开发的编程基础','机械工业出版社',3,'23424','教材类',NULL,NULL,'265','26com*15cm',NULL,'快递','20110604_fda2a78cffb1fc3b5b0dZ0tYw0VCqT5o.jpg','骆斌','无'),(9,'hmj','软件开发的技术基础','机械工业出版社',2,'43252','教材类',NULL,NULL,'433','26com*15cm',NULL,'面送','5170599_152928389000_2 (2).jpg','骆斌','无'),(10,'hmj','大王派我来巡山','民大',3,'5435','',NULL,NULL,'','',NULL,'','8952533_164223473001_2.jpg','','');
...
CREATE TABLE `order` (
  ...
  CONSTRAINT `order_ibfk_3` FOREIGN KEY (`bookID`) REFERENCES `book` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  CONSTRAINT `order_ibfk_4` FOREIGN KEY (`buyerID`) REFERENCES `user` (`id`) ON DELETE CASCADE ON UPDATE CASCADE
) ENGINE=InnoDB AUTO_INCREMENT=5 DEFAULT CHARSET=utf8;

/*Data for the table `order` */

insert  into `order`(`id`,`saler`,`buyerID`,`bookID`,`price`,`salerID`,`picture`) values (3,'dskkfds',2,3,45,NULL,NULL),(4,'erwet',2,3,54,NULL,NULL);
...
CREATE TABLE `shoplist` (
  ...
  PRIMARY KEY (`id`),
  KEY `FKEB762094F38B02FF` (`bookid`),
  KEY `FKEB7620941433B443` (`userid`),
  CONSTRAINT `FKEB7620941433B443` FOREIGN KEY (`userid`) REFERENCES `user` (`id`),
  CONSTRAINT `FKEB762094F38B02FF` FOREIGN KEY (`bookid`) REFERENCES `book` (`id`)
